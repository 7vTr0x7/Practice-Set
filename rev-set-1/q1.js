...
function calculateAndTotalMarks() {
...
calculateAndTotalMarks();

console.log("----------- ------------- -----------");
console.log(studentsMarks);
console.log("----------- ------------- -----------");

function getStudentsWithTotalMarksAbove345() {
  for (let i = 0; i < studentsMarks.length; i++) {
    if (studentsMarks[i].totalMarks > 345) {
      console.log("Student Name:", studentsMarks[i].name);
    }
  }
}

getStudentsWithTotalMarksAbove345();
